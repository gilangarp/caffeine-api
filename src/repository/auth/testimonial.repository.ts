...
import { IDataTestimonial, IDataTestimonialBody } from "../../model/auth/testimonial.model";
import db from "../../configs/pg";
import { IUsersQuery } from "../../model/auth/user.model";

export const createData = (
  body: IDataTestimonialBody,
  id: string
): Promise<QueryResult<IDataTestimonial>> => {
...
export const getTotalTestimonialData = (): Promise<
